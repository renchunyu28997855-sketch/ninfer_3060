...
std::size_t linear_workspace_capacity_bytes(QType qtype, std::int32_t output_rows,
    ...
    case QType::Q8_G32_FP16:
        ...
        return 0;
    case QType::T2_G128_FP16:
        // The GEMM decodes inside the kernel, but the folded-basis activation rotation needs a
        // [K, T] BF16 scratch; missing this case rejects every ternary weight up front.
