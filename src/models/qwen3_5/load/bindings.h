...
public:
    ...
    // Shared folded-ternary sign blocks (FP32, converted from the artifact's BF16 auxiliary
    // objects), deduplicated by element count; WeightUse::hadamard_table indexes into this.
