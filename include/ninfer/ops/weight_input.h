...
struct WeightInput {
    ...
    // Folded ternary (T2_G128_FP16) rotation metadata. nullptr means the parameter carries no
    // sign block; the ops treat it as an untransformed payload and never apply the rotation.
