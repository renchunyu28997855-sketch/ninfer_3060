 ...
 *
 * Folded (rotated-basis) ternary parents, T2_G128_FP16 [4096,5120] and [12288,5120], are
 * admitted here and only here: their activation has to be mapped into the rotated basis before
 * the matmul, and that scratch comes from the workspace. The rotation is shared across the
 * three projections, so it is paid once per call rather than once per parent.
 *
 * Workspace:
